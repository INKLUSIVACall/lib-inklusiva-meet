...
import ICRole from './ICRoleAdditions';
...
export default class JitsiConference {
  ...
  onICMemberRoleUpdate: ( jid:string, roles: any ) => void;
  getMemberICRoles: ( id: string ) => ICRole[];
  ...
  removeLocalICRole: ( icRoleName: string, rolePartner?: string| null) => void;
